    ...
    <div className="bg-white border absolute z-0 flex min-h-[268px] w-[576px] max-w-full overflow-hidden text-[11px] text-neutral-900 font-normal leading-[1.2] h-[268px] rounded-lg border-[rgba(0,89,235,1)] border-solid left-6 top-[57px]">
      <div className="bg-[rgba(238,238,238,1)] overflow-hidden w-[195px]">
        <div className="border-neutral-200 flex w-full items-center gap-1 text-xs font-bold pl-5 pr-3 py-3 border-b-2">
          <div className="self-stretch flex items-center gap-1 my-auto">
            <div className="self-stretch gap-2.5 my-auto">
              Gong Call Primary Account
            </div>
            <img
              src="https://cdn.builder.io/api/v1/image/assets/608cb3afdcd244e7a1995ba6f432cc7d/1d2d5e969d6289a867288e29f0b4f8e84d33496e?placeholderIfAbsent=true"
        ...
        {Array(8)
          ...
          .map((_, index) => (
            <div
              key={`cell-1-${index}`}
              className="bg-[rgba(238,238,238,1)] border-neutral-200 min-h-7 w-full whitespace-nowrap pl-5 pr-3 border-b"
            >
              142676
            </div>
          ))}
      ...
      <div className="bg-white w-[130px]">
        ...
        {Array(8)
          ...
          .map((_, index) => (
            <div
              key={`cell-2-${index}`}
              className="bg-white border-neutral-200 min-h-7 w-full px-3 border-b"
            >
              2021-09-26 15:54:13
            </div>
          ))}
      ...
      <div className="bg-white text-right w-[118px]">
        <div className="bg-[rgba(238,238,238,1)] border-neutral-200 flex min-h-10 w-full items-center gap-1 text-xs font-bold px-3 py-[13px] border-b-2">
          <div className="self-stretch flex items-center gap-1 my-auto">
            <div className="self-stretch gap-2.5 my-auto">Quantity Number</div>
          </div>
        </div>
        {Array(8)
          .fill(0)
          .map((_, index) => (
            <div
              key={`cell-3-${index}`}
              className="bg-white border-neutral-200 min-h-7 w-full whitespace-nowrap px-3 border-b"
            >
              {index === 3 || index === 7 ? "2" : "1"}
            </div>
          ))}
      ...
      <div className="bg-white w-[95px]">
        <div className="bg-[rgba(238,238,238,1)] border-neutral-200 flex min-h-10 w-full items-center gap-1 text-xs font-bold px-3 py-[13px] border-b-2">
          <div className="self-stretch flex items-center gap-1 my-auto">
            <div className="self-stretch gap-2.5 my-auto">Product Type</div>
          </div>
        </div>
        {Array(8)
          .fill(0)
      ...
      <div className="bg-white w-[93px]">
        <div className="bg-[rgba(238,238,238,1)] border-neutral-200 flex min-h-10 w-full items-center gap-1 text-xs font-bold px-3 py-[13px] border-b-2">
          <div className="self-stretch flex items-center gap-1 my-auto">
            <div className="self-stretch gap-2.5 my-auto">Store Region</div>
          </div>
        </div>
        {Array(8)
          .fill(0)
