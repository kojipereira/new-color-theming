...
const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({
  ...
  // Use different classes for sticky vs. inline to prevent animation conflicts
  const containerClasses = isSticky 
    ? "sticky bottom-0 z-10 bg-[rgba(238,238,238,1)] transition-opacity duration-300 ease-in-out" 
    : "bg-[rgba(238,238,238,1)] transition-opacity duration-300 ease-in-out";
