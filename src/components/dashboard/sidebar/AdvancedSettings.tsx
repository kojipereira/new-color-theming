...
const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({
  ...
  const containerClasses = isSticky ? "sticky bottom-0 z-10 bg-[rgba(238,238,238,1)] transition-opacity duration-150" : "bg-[rgba(238,238,238,1)] transition-opacity duration-150";
