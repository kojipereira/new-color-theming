...
const SidebarHeader: React.FC = () => {
  return (
    <div className="rounded w-full overflow-hidden">
      <div className="bg-white flex w-full flex-col overflow-hidden items-stretch justify-center p-1 py-3">
        <div className="flex w-full items-center gap-2 px-2">
          ...
          <div className="text-neutral-900 text-ellipsis text-base font-bold self-stretch flex-1 shrink basis-[0%] my-auto truncate">
            Automation status
          </div>
          <div className="rounded self-stretch flex items-center gap-0.5 overflow-hidden justify-center w-6 my-auto p-1">
            <img
      ...
      <div className="bg-white flex w-full flex-col overflow-hidden items-stretch justify-center p-1 py-2">
        <div className="flex min-h-6 w-full items-center px-2">
          <div className="self-stretch flex w-full items-center flex-1 shrink basis-[0%] my-auto">
            <div className="self-stretch flex items-center gap-2 flex-1 shrink basis-[0%] my-auto">
              ...
              <div className="text-[#505050] text-ellipsis text-xs font-normal leading-none self-stretch flex-1 shrink basis-[0%] my-auto truncate">
